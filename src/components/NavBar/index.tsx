    ...
    return (
        <header className={styles.navBar}>
            <div className={styles.logo}>
                <svg className={styles.logoIconSvg} viewBox="0 0 64 36" xmlns="http://www.w3.org/2000/svg" fill="none">
                    <path fill="black"
            ...
            <div className={styles.aside}>
                ...
                <a className={styles.link} href="#">Chrome extension</a>
                <a className={styles.link} href="#">Use cases</a>
                <a className={styles.link} href="#">
                    <img src="https://hatscripts.github.io/circle-flags/flags/cn.svg" alt="Chinese"
